...
export default function HomePage() {
  return (
    <div className="bg-[#f8faf8]">
      <div className="max-w-[1280px] mx-auto px-4 md:px-6 pt-6 pb-16 flex gap-8">
          ...
          <div className="grid grid-cols-3 gap-4 h-48">
            ...
            <div className="col-span-2 bg-[#006f1d] rounded-2xl overflow-hidden relative flex items-center">
              ...
              <div className="relative z-10 p-4 md:p-8">
                ...
                <h2 className="text-white font-extrabold text-xl md:text-[30px] md:leading-[37.5px] mb-3">
                  Grosir Minyak Goreng<br />Diskon s/d 15%
                </h2>
                <p className="text-[#eaffe2] text-xs md:text-sm leading-5">
            ...
            {/* Secondary promo */}
            <div className="bg-[#d5e8cf] rounded-2xl overflow-hidden relative p-4 md:p-6 flex flex-col justify-between">
              <div className="absolute bottom-[-16px] right-[-16px] bg-[rgba(0,111,29,0.1)] rounded-full size-32 blur-xl" />
              <div className="relative z-10">
                <h3 className="text-[#465643] font-bold text-sm md:text-lg md:leading-[24.75px] mb-1">
                  Peralatan<br />Rumah Tangga
                </h3>
                <p className="text-[rgba(70,86,67,0.7)] text-[10px] md:text-xs">Lengkap & Ekonomis</p>
              </div>
              <button className="relative z-10 flex items-center gap-1 text-[#006f1d] text-[10px] md:text-xs font-bold hover:underline self-start">
                Lihat Semua →
              </button>
            </div>
          </div>
